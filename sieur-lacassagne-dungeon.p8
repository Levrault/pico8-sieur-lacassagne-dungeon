...
function make_game_manager()
	...
	gm.set_level=function(self,level)
		...
		elseif level==8 then--x[0,128] y[128,256]
			self.d_cam_x=896
			self.d_cam_y=128

			add(enemies,make_bat(68,180,{x=20,y=0}))
			add(enemies,make_bat(68,140,{x=0,y=0}))
			add(enemies,make_skeleton(60,146))
			self.coin=make_coin(116,128)
			self.player=make_player(12,140)
		end
	end
...

...

...

...

__sfx__
